...
// thin mutateShortcut call. Split out of shortcutStoreMutation.ts (which now holds
// only restore/promote-recipe, via ShortcutStoreRestore) purely to keep that file
// under the project's line-count cap.
export abstract class ShortcutStoreFieldUpdates extends ShortcutStoreMutationCore {
