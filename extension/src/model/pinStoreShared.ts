import { PinScope } from "./pin";
import { RecipeCategory } from "../recipes/detectors";

// Shared constants, helpers, and the MoveTarget type for the PinStore class chain
// (pinStoreBase -> pinStoreRecipes -> pinStoreRefresh -> pinStoreMutation ->
// pinStoreSets -> PinStore). Kept in one leaf module so every class layer imports
